            ...
            <div className="bg-card rounded-3xl p-8 md:p-10 shadow-sm border border-border">
              {isSubmitted ? <div className="text-center py-12">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="name" name="name" type="text" placeholder="Jane Smith" value={formData.name} onChange={handleChange} required className="h-14 text-lg rounded-xl" />
                  </div>
                  ...
                  <div className="grid gap-6 sm:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <Input id="phone" name="phone" type="tel" placeholder="(555) 123-4567" value={formData.phone} onChange={handleChange} className="h-14 text-lg rounded-xl" />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="email" className="text-base font-medium">
                        Email Address
                      </Label>
                      <Input id="email" name="email" type="email" placeholder="jane@example.com" value={formData.email} onChange={handleChange} className="h-14 text-lg rounded-xl" />
                    </div>
                  </div>
                  ...
                  <Button type="submit" size="lg" disabled={isSubmitting} className="w-full rounded-full text-lg py-7">
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <a href="mailto:pauline@bonded-care.com" className="flex items-start gap-4 p-6 bg-accent/50 rounded-2xl hover:bg-accent transition-colors group">
                    <div className="w-14 h-14 rounded-full bg-primary/10 flex items-center justify-center flex-shrink-0 group-hover:bg-primary/20 transition-colors">
                  ...
                  <div className="flex items-start gap-4 p-6 bg-accent/50 rounded-2xl">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">Proudly serving Ottawa and surrounding areas (Stittsville, Almonte, Carp, Carleton Place, Richmond, Munster, Perth) </p>
                    </div>
                  </div>
                </div>
              </div>

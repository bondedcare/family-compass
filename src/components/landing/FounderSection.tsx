            ...
            <div className="grid md:grid-cols-[280px_1fr] lg:grid-cols-[320px_1fr] gap-10 md:gap-12 items-start">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-5 text-lg text-muted-foreground leading-relaxed">
                  <p>
                    For over 20 years, I've built my career around one thing: making sure 
                    nothing falls through the cracks. Whether coordinating complex schedules, 
                    managing logistics, or simply ensuring every detail is handled with care, 
                    I've always believed that reliability and attention to detail make all 
                    the difference.
                  </p>

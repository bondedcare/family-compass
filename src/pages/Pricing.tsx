...
const hourlyServices: PriceRow[] = [
  { service: "Errands & Deliveries", rate: "$35 / hour", note: "1-hour minimum" },
  { service: "Check-Ins & Connection (in person)", rate: "$35 / hour" },
  { service: "Scheduled Family Video Calls", rate: "$25 / 30 min" },
  { service: "General Home Help", rate: "$35 / hour" },
  { service: "Gift Pickup & Delivery", rate: "$35 / hour", note: "Plus cost of gift" },
  { service: "Odd Jobs & Pet Care", rate: "$35 / hour" },
          ...
          <div className="container px-4 md:px-6">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-center text-sm text-muted-foreground mt-10 max-w-2xl mx-auto">
                Invoices are sent by email after each visit (or monthly for
